...
typedef enum {
     ...
     * - right: Argument value (AST_EXPRESSION for calls, AST_IDENTIFIER for definitions)
     * - name:  NULL
     */
    AST_FUNC_ARG,
 ...
 * The interpretation of each field depends on the node's type (see ASTNodeType).
 * 
...
typedef struct ASTNode {
     ...
     *  Used in function definitions to track all variables declared in the function */
 ...
 * @param name Optional name/identifier for the node (will be duplicated), may be NULL
 ...
 *       - The node itself
 * @warning Do not access the node or any of its children after calling this function
 */
